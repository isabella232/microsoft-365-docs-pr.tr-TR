...
- Office 365 Gelişmiş Tehdit Koruma Planı 1 ve Windows Defender Exploit Guard ile kimlik avı ve gelişmiş kötü amaçlı yazılım gibi dış tehditlere karşı koruma sağlamaya yardımcı olur. 
-  Office 365 veri kaybıönleme ilkeleri ve Azure Bilgi Koruma Planı 1 ile hassas bilgilere nasıl erişilip aktarılabildiğini denetlemeye ve yönetmeye yardımcı olur. 
...
Microsoft 365 Business ile yönetilen bilgisayarların Windows Defender ile korunduğu, bu da "Hayır" olarak karşılanır. Windows 10'da 1 virüsten koruma özelliği, virüslere, kötü amaçlı yazılımlara, casus yazılımlara ve diğer tehditlere karşı diğer tüm çözümlerden daha fazla bilgisayarı korur.  Microsoft 365 Business ile kuruluşlar, Windows Defender korumasının çalışmasını ve tüm Windows 10 cihazlarında her zaman güncel olmasını sağlayabilir.  
...
Evet, müşteriler planlarını uygun bir Office 365 planından Microsoft 365 Business'a değiştirebilir. Müşterinin geçerli planına bağlı olarak, aylık ücretlerde bir azalma veya artış olabilir.

### <a name="in-what-regions-is-microsoft-365-business-available"></a>Microsoft 365 Business hangi bölgelerde kullanılabilir? 

Microsoft 365 Business, Office 365'in kullanılabildiği tüm iş ortakları ve müşteriler tarafından kullanılabilir. <a href="https://products.office.com/business/international-availability" target="_blank">Diller, ülkeler ve bölgeler için Office 365 uluslararası kullanılabilirlik</a>listesine bakın. 
...
Microsoft 365 Business'ın tüm özelliklerini yaşamak isteyen müşterilerin Windows 7, 8.1 veya 10 Pro<sup>[2'yi](#footnote2)</sup> mevcut masaüstünde çalıştırması gerekir. Mevcut Windows 10 Pro bilgisayarları, daha önce yapmamışlarsa Creators Update'i çalıştırıyor olmalıdır. 
...
Eskiden Microsoft 365 Business'ın Koşullu Erişim, self servis parola sıfırlama ve Çok Faktörlü Kimlik Doğrulama gibi Azure AD Premium Plan 1 özelliklerinin bir alt kümesi vardı. Şimdi microsoft 365 Business abonelerine, önce yeni müşterilere, daha sonra da mevcut abonelere azure AD Premium P1 lisansının tamamını kullanıma sıyoruz. Daha fazla bilgi için [Microsoft 365 İş Hizmeti Açıklaması'na](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-business-service-description) ve bu [bloga](https://techcommunity.microsoft.com/t5/small-and-medium-business-blog/azure-active-directory-premium-p1-is-coming-to-microsoft-365/ba-p/1275496)bakın.
