...
|Kullanıcılar içeriği Office uygulamaları kişisel apps kopyalamak izin verme  <br/> |**Ayarı etkin**olduğunda, kullanıcı bilgileri iş dosyasında kişisel dosya kopyalayamazsınız. Bu ayar **devre**dışıysa, kullanıcı bilgileri iş dosyasından kişisel app ya da kişisel hesap kopyalayabilirsiniz.  <br/> |
